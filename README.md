...
- **Hardware Working:[Hardware Image 1]** ![Hardware Image 1](./Photos/Hardware/Pic1.jpeg)
- **Hardware Working:[Hardware Image 2]** ![Hardware Image 2](./Photos/Hardware/Pic2.jpeg)
- **Wokwi Simulation:[Wokwi Setup Architecture]** ![Wokwi Setup Architecture](./Photos/Simulation/Simulation1.png)
- **Wokwi Simulation:[Green Stage]** ![Green Stage](./Photos/Simulation/SimulationGreen.png)
- **Wokwi Simulation:[Amber Stage]** ![Amber Stage](./Photos/Simulation/SimulationYellow.png)
- **Wokwi Simulation:[Red Stage]** ![Red Stage](./Photos/Simulation/SimulationRed.png)
- **Software View:[Dashboard UI]** ![Dashboard UI](./Photos/Software/SoftwareBins.png)
- **Software View:[Map & Routing]** ![Map & Routing](./Photos/Software/SoftwarePath.png)
